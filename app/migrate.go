...
//This file implements a genesis migration from dexhub-3 to dexhub-4. It migrates state from the modules in dexhub-3.
...
import (
	...
	bank "github.com/mydexchain/chain-sdk/x/bank/types"
	captypes "github.com/mydexchain/chain-sdk/x/capability/types"
	evtypes "github.com/mydexchain/chain-sdk/x/evidence/types"
	"github.com/mydexchain/chain-sdk/x/genutil/client/cli"
	"github.com/mydexchain/chain-sdk/x/genutil/types"
	ibcxfertypes "github.com/mydexchain/chain-sdk/x/ibc/applications/transfer/types"
	host "github.com/mydexchain/chain-sdk/x/ibc/core/24-host"
	"github.com/mydexchain/chain-sdk/x/ibc/core/exported"
	ibccoretypes "github.com/mydexchain/chain-sdk/x/ibc/core/types"
	staking "github.com/mydexchain/chain-sdk/x/staking/types"
...
Example:
$ %s migrate /path/to/genesis.json --chain-id=dexhub-4 --genesis-time=2019-04-22T17:00:00Z --initial-height=5000
`, version.AppName),
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			bankGenesis.DenomMetadata = []bank.Metadata{
				{
					Description: "The native staking token of the Dex Hub.",
