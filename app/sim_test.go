...
import (
	...
	"github.com/mydexchain/dextracker/v3/app/helpers"
	"github.com/stretchr/testify/require"
	"github.com/mydexchain/tendermint/libs/log"
	"github.com/mydexchain/tendermint/libs/rand"
	...
	simulation2 "github.com/mydexchain/chain-sdk/types/simulation"
	"github.com/mydexchain/chain-sdk/x/simulation"
)
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/mydexchain/chain-sdk/GaiaApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
