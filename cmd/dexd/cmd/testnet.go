...
import (
	...
	tmconfig "github.com/mydexchain/tendermint/config"
	...
	tmtime "github.com/mydexchain/tendermint/types/time"

	"github.com/mydexchain/chain-sdk/client"
	"github.com/mydexchain/chain-sdk/client/flags"
	"github.com/mydexchain/chain-sdk/client/tx"
	"github.com/mydexchain/chain-sdk/crypto/hd"
	"github.com/mydexchain/chain-sdk/crypto/keyring"
	cryptotypes "github.com/mydexchain/chain-sdk/crypto/types"
	"github.com/mydexchain/chain-sdk/server"
	srvconfig "github.com/mydexchain/chain-sdk/server/config"
...
Example:
	dexd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "dexd", "Home directory of the node's daemon configuration")
